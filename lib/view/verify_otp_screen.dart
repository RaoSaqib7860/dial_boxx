...
class VerifyOtpScreen extends StatefulWidget {
  ...
  const VerifyOtpScreen({super.key, this.callFromBusiness, this.callFromConfirm});
        ...
        child: SizedBox.expand(
          child: Container(
            ...
            decoration: BoxDecoration(
                color: AppColors.whitColor, borderRadius: BorderRadius.only(topRight: Radius.circular(35.sp), topLeft: Radius.circular(35.sp))),
            child: Padding(
                        ...
                        onTap: () {
                          widget.callFromBusiness == 0
                              ...
                              : Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>const ConfirmForgotPasswordScreen(),
                                  ));
                        },
