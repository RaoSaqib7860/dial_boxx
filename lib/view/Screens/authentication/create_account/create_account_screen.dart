...
import 'create_accout_controller/create_controoler.dart';
...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  var sendOtpController = Get.put(otpController());
      ...
      body: Obx(()=> SingleChildScrollView(
        child: Stack(
          children: [
                    ...
                    children: [
                      ...
                      index == 0
                        ...
                        child: SizedBox(
                          ...
                          width: MediaQuery.of(context).size.width,
                          child: TextFormField(
                            controller: sendOtpController.textEditingControllerEmail,
                      ...
                      GestureDetector(
                        onTap: () {
                          if(sendOtpController.isLoading.value ==false){
                            sendOtpController.sendOtp(context: context);
                          }
                          // Navigator.push(
                          //     context,
                          //     CupertinoPageRoute(
            ...
            Visibility(
              visible: sendOtpController.isLoading.value,
              child: Center(
                child: Container(
                  height: 100.h,
                  width: 100.w,
