...
class _AddPaymentMethodScreenState extends State<AddPaymentMethodScreen> with TickerProviderStateMixin {
  late TabController _tabController;
  bool bootomsheetstatus = false;
  var ordersList = ['All Orders(10)', 'Today(2)', 'Yesterday(4)', 'This Week(8)'];
  int selectColor = 0;
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(fontSize: 15.sp, color: Color(0xff838383)),
                              ...
                              return Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                      ...
                                      width: 125.w,
                                      decoration: BoxDecoration(
                                          color: selectColor == index ? AppColors.primaryColor : Colors.white,
                                          border: Border.all(),
                                          borderRadius: BorderRadius.circular(30.sp)),
                                      child: Center(
                                        child: CustomText(
                                          text: ordersList[index],
                                          color: selectColor == index ? Colors.white : Colors.black,
                                          fontWeight: selectColor == index ? FontWeight.w600 : FontWeight.w400,
                                        ),
                                      )),
                                ),
                              );
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  margin: EdgeInsets.only(top: 8.h,left: 4,right: 4),
                                  decoration: BoxDecoration(
                                        color: AppColors.whitColor,
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        borderRadius: BorderRadius.circular(4.sp),
                                                        boxShadow: [
                                                          BoxShadow(blurRadius: 2, spreadRadius: 1, color: Colors.black12.withOpacity(0.10))
                                                        ]),
                                                    child: Padding(
                                                      padding: EdgeInsets.symmetric(horizontal: 4.w),
                                                      child: Row(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              height: 27.h,
                              width: 150.w,
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(2.sp), border: Border.all(color: Color(0xff707070))),
                              child: Padding(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        ...
                        child: CustomButtonClick(
                          height: 45.h,
                          width: MediaQuery.of(context).size.width,
                          decoration: BoxDecoration(color: AppColors.primaryColor, borderRadius: BorderRadius.circular(3.sp)),
                          child: Center(
                            child: CustomText(
